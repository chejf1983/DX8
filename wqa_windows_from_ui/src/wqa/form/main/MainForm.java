...
public class MainForm extends javax.swing.JFrame {
    ...
    private void InitHeadPane() {
        ...
        this.initLabelButton(LB_Alarm, "设备配置", "alarm");
    ...
    private void LB_SearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LB_SearchMouseClicked
        ...
        if (dialog.GetResult() != IOConfigDialog.SEARCH_MIGP) {
            return;
        }
...
//                WQAPlatform.GetInstance().GetManager().SearchDevice(new ShareIO[]{WQAPlatform.GetInstance().GetIOManager().ADDShareIO(MOCKIO.CreateIO())}, new IMainProcess() {
                    @Override
...
//        work_layout.show(work_area, AlarmSearch.class.getSimpleName());
        DevControl[] GetAllControls = WQAPlatform.GetInstance().GetManager().GetAllControls();
        DevConfigTable[] configs = new DevConfigTable[GetAllControls.length];
        for (int i = 0; i < configs.length; i++) {
            configs[i] = GetAllControls[i].GetConfigTable();
        }
        CommonConfigForm config_form = new CommonConfigForm(MainForm.main_parent, false, "参数设置");
        try {
            if (config_form.InitModel(configs)) {
...
//        this.work_area.add(AlarmSearch.class.getSimpleName(), new AlarmSearch());
    ...
    private void initComponents() {
        ...
        LB_RunStop = new javax.swing.JLabel();
        Tx_time = new javax.swing.JTextField();
        Label_LeftTime = new javax.swing.JLabel();
        ...
        LB_RunStop.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LB_RunStop.setText("jLabel2");
        LB_RunStop.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        LB_RunStop.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        LB_RunStop.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        Label_LeftTime.setForeground(new java.awt.Color(255, 255, 255));
        Label_LeftTime.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Label_LeftTime.setText("剩余:0秒");

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("一直运行设 0");
        ...
        HeadPaneLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, HeadPaneLayout.createSequentialGroup()
                ...
                .addComponent(LB_RunStop, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                .addGroup(HeadPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Label_LeftTime, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Tx_time, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        HeadPaneLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {LB_RunStop, LB_Search});

        HeadPaneLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Label_LeftTime, Tx_time, jLabel2});
        ...
        HeadPaneLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, HeadPaneLayout.createSequentialGroup()
                .addGroup(HeadPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(LB_RunStop, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void initRunButton() {
        String path = "/wqa/form/main/resource/";
        //设置图片在上，文字在下
        LB_RunStop.setVerticalTextPosition(BOTTOM);
        LB_RunStop.setHorizontalTextPosition(CENTER);
        LB_RunStop.setHorizontalAlignment(CENTER);
        //设置默认背景图片
        URL resource = getClass().getResource(path + "run.png");
        LB_RunStop.setIcon(new javax.swing.ImageIcon(resource));

        LB_RunStop.setText("");
        //设置背景颜色
        LB_RunStop.setBackground(new Color(34, 141, 232));
        LB_RunStop.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent me) {
                LB_RunStop.setOpaque(true);
                LB_RunStop.updateUI();
            }

            @Override
            public void mouseExited(MouseEvent me) {
                LB_RunStop.setOpaque(false);
                LB_RunStop.updateUI();
            }
        });

    }
    private void LB_RunStopMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LB_RunStopMouseClicked
        DevControl[] controls = WQAPlatform.GetInstance().GetManager().GetAllControls();
        String path = "/wqa/form/main/resource/";

        if (controls.length > 0) {
            if (controls[0].isStart_collect()) {
                controls[0].setStart_collect(false);
                URL resource = getClass().getResource(path + "run.png");
                LB_RunStop.setIcon(new javax.swing.ImageIcon(resource));
            } else {
                Integer time = 0;
                try {
                    time = Integer.valueOf(this.Tx_time.getText());
                } catch (Exception ex) {
                    Tx_time.setText("0");
                }
                controls[0].setRuntime(time, value -> {
                    java.awt.EventQueue.invokeLater(() -> {
                        if (!value) {
                            //设置默认背景图片
                            URL resource = getClass().getResource(path + "run.png");
                        ...
                        Label_LeftTime.setText("剩余:" + controls[0].getRuntime() + "秒");
                    });
                });
                controls[0].setStart_collect(true);
                //设置默认背景图片
                URL resource = getClass().getResource(path + "stop.png");
                LB_RunStop.setIcon(new javax.swing.ImageIcon(resource));
            }
//            controls[0];
        }
    ...
    private javax.swing.JLabel LB_RunStop;
    private javax.swing.JLabel LB_Search;
    private javax.swing.JLabel Label_LeftTime;
